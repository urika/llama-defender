...
# (above moved to content_compressor.py: _scrub_ansi, _detect_content_type,
#  _sieve_json, _compress_code, _compress_log, _compress_text, _dedupe_scalars,
#  _audit_compression, compress_tool_result, _generate_tool_summary)
